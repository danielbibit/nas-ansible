...
# Credits:
# https://www.truenas.com/community/threads/scripts-to-report-smart-zpool-and-ups-status-hdd-cpu-t%C2%B0-hdd-identification-and-backup-the-config.27365/
# https://pastebin.com/9xBRFFuB

### Parameters ###
logfile="/tmp/smart_report.tmp"
email="{{ email_report_to }}"
subject="SMART Status Report for NAS"
# drives="da0 da1 da2 da3 da4 da5 da6 da7"

drives=$(for drive in $(lsblk -l | grep disk | awk '{print $1}'); do \
